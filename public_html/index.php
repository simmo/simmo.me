...
<html lang="en-gb" class="no-js">
  <head>
    ...
    <link rel="stylesheet" href="<?= asset_url('application.css') ?>">
    <script src="<?= asset_url('modernizr.js') ?>"></script>
  ...
  <body>
        ...
        <article class="page">
          <div class="container">
            ...
            <figure class="browser" data-animate>
              <div class="browser__content"><img src="<?= asset_url($project['image']) ?>" class="project__image"></div>
            </figure>
          </div>
        </article>
      <? endforeach ?>
          ...
          <div class="container">
            <div class="grid">
              <div class="grid__cell unit-2-3--medium">
                ...
                <p>You can also find me on; <a href="http://twitter.com/mikesimmonds" target="_blank">Twitter</a>, <a href="http://github.com/simmo" target="_blank">GitHub</a>, <a href="http://stackoverflow.com/users/547345/mike" target="_blank">Stack Overflow</a>, <a href="http://instagram.com/mikesimmonds" target="_blank">Instagram</a> and <a href="http://lnkd.in/2T4KbK" target="_blank">LinkedIn</a>.</p>
    ...
    <script>window.jQuery || document.write('<script src="<?= asset_url('jquery.js') ?>"><\/script>')</script>
    <script src="<?= asset_url('application.min.js') ?>"></script>
  </body>
</html>
